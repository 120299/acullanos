                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="form2" name="form2" method="POST" action="request.php">
                                            ...
                                            if ($_POST["buscar"] == '' and $_POST['buscafechadesde'] == '' and $_POST['buscafechahasta'] == '') {
                                                ...
                                                if ($_POST["buscar"] != '') {
                                                    $query .= "WHERE (name LIKE LOWER('%" . $aKeyword[0] . "%') OR phone LIKE LOWER('%" . $aKeyword[0] . "%') OR company LIKE LOWER('%" . $aKeyword[0] . "%') OR city LIKE LOWER('%" . $aKeyword[0] . "%')) ";

                                                    for ($i = 1; $i < count($aKeyword); $i++) {
                                                        if (!empty($aKeyword[$i])) {
                                                            $query .= " OR name LIKE '%" . $aKeyword[$i] . "%' OR phone LIKE '%" . $aKeyword[$i] . "%' OR company LIKE '%" . $aKeyword[$i] . "%' OR city LIKE '%" . $aKeyword[$i] . "%'";
                                                        }
                                                    }
                                                }
                                            ...
                                            <table class="table align-middle table-hover ">
                                                <thead>
                                                    <tr style="background-color:#ef7f1a; color:#FFFFFF;font-size:15px">
                                                        <th  style="background: #a60000;padding-left: 50px;padding-right: 50px;">
                                                            <span class="text-center" style="background: #4200fc;color: rgb(255,255,255);text-align: center;">
                                                                Empresa
                                                            </span>
                                                        </th>
                                                        <th  style="background: #a60000;padding-left: 50px;padding-right: 50px;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="text-center">
                                                        <th scope="row"><?php echo $rowSql["company"]; ?> </th>
                                                        <td>
                                                            <?php echo $rowSql["nit"]; ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td><?php echo $rowSql["phone"]; ?>
                                                        </td>
                                                        <td><?php echo $rowSql["street"]; ?>
                                                            <br>
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div class="mb-3">
                                                                                                    ...
                                                                                                    <select name="city"
                                                                                                        ...
                                                                                                        required
                                                                                                        class="form-control">
                                                                                                        <option <?php if ($rowSql["city"] == $rowSql["city"]) {
                                                                                                                print ' selected ';
                                                                                                            } ?>
