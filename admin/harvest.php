        ...
        <nav
            ...
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="request.php"><i class="fas fa-table"></i><span>Solicitudes de
                                Recolecci&oacute;n</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="request.php"><i class="fas fa-table"></i><span>Detalles de
                                Recolecci&oacute;n</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid mt-5">
                    <h3 class="text-dark mb-4">Detalles de recolecci&oacute;n</h3>
                            ...
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form id="form2" name="form2" method="POST" action="table.php">
                                            ...
                                            if ($_POST["buscar"] == '' and $_POST['buscafechadesde'] == '' and $_POST['buscafechahasta'] == '') {
                                                ...
                                                if ($_POST["buscar"] != '') {
                                                    $query .= "WHERE (name LIKE LOWER('%" . $aKeyword[0] . "%') OR phone LIKE LOWER('%" . $aKeyword[0] . "%') OR city LIKE LOWER('%" . $aKeyword[0] . "%')) ";

                                                    for ($i = 1; $i < count($aKeyword); $i++) {
                                                        if (!empty($aKeyword[$i])) {
                                                            $query .= " OR name LIKE '%" . $aKeyword[$i] . "%' OR phone LIKE '%" . $aKeyword[$i] . "%'  OR city LIKE '%" . $aKeyword[$i] . "%'";
                                                        }
                                                    }
                                                }

                                                if ($_POST["buscafechadesde"] != '') {
                                                    $query .= " AND recoleccion BETWEEN '" . $_POST["buscafechadesde"] . "' AND '" . $_POST["buscafechahasta"] . "' ";
                                                }
                                                ...
                                                if ($_POST["orden"] == '2') {
                                                    $query .= " ORDER BY recoleccion ASC ";
                                                }

                                                if ($_POST["orden"] == '3') {
                                                    $query .= " ORDER BY recoleccion DESC ";
                                                }

                                                if ($_POST["orden"] == '4') {
                                                    $query .= " ORDER BY solicitudkg ASC ";
                                                }
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead>
                                                    <tr style="background-color:#ef7f1a; color:#FFFFFF;font-size:15px">
                                                        <th class="py-4 mx-auto" scope="col"
                                                            style=" text-align: center;">
                                                            Nombre de contancto </th>
                                                        <th class="py-4" scope="col" style=" text-align: center;">
                                                            N&uacute;mero de contancto </th>
                                                        <th class="py-4" scope="col" style=" text-align: center;">
                                                            Dirreci&oacute;n </th>
                                                        <th class="py-4" scope="col" style=" text-align: center;">
                                                            Cantidad</th>
                                                        <th class="py-4" scope="col" style=" text-align: center;"> Fecha
                                                            de radicado </th>
                                                        <th class="py-4" scope="col" style=" text-align: center;"> Fecha
                                                            de solicitud </th>
                                                        <th class="py-4" scope="col" style=" text-align: center;">Fecha de recolecci&oacute;n </th>
                                                        <th class="py-4" scope="col" style=" text-align: center;">Descargar certificado </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="text-align:center;">
                                                            <?php echo $rowSql["name"]; ?>
                                                        </td>
                                                        <td style="text-align:center;"><?php echo $rowSql["phone"]; ?>
                                                        </td>
                                                        <td style="text-align:center;"><?php echo $rowSql["street"]; ?>
                                                            <br>
                                                            <?php echo $rowSql["city"]; ?> -
                                                            <?php echo $rowSql["departament"]; ?>
                                                        </td>
                                                        <td style="text-align:center;">
                                                            <?php echo $rowSql["solicitudkg"]; ?>kg</td>
                                                        <td style="text-align:center;">
