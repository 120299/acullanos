                    ...
                    <div class="row mb-3">
                                    ...
                                    <form name="frm" class="post-form-wrapper" action="app/new-pass.php" method="POST">
                                        ...
                                        <div class="mb-3">
                                            <button type="submit" onclick="return check_passwords();"
                                                class="btn btn-secondary">Actualizar contraseña</button>
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                        ...
                                        <div class="card-body">
                                            <form id="f1" name="f1" action="app/add-profile.php" method="POST"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="phone"><strong>Teléfono de
                              ...
                              print ' selected ';
                          } ?> value="Comidas Rápidas">Comidas Rápidas</option>
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" type="text" id="kg"
                                                                value="<?php echo "$mykg"; ?>"
                                                                placeholder="Ingrese la cantidad en número" name="kg">
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="harvest">
                                                                <strong>Frecuencia de recolección</strong>
                                                            </label>
