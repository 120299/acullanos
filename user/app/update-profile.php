...
try {
    ...
    $stmt = $conn->prepare("UPDATE tbl_users SET company = :company, nit = :nit, name = :name, phone = :phone, email = :email, establishment = :establishment, street = :street, departament = :departament , city = :city , kg = :kg, harvest = :harvest WHERE member_no='$myid'"
);
...
$_SESSION['myharvest'] = $myharvest;
    header("location:../table.php?r=6734");
